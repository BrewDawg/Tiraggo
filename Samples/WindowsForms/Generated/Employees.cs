//==============================================================
// Tiraggo "Generated" class generated by My2ndGeneration
//
// Never hand edit this class, make all changes in the "Custom"
// classes.
//==============================================================
using System;
...
namespace BusinessObjects
{
	...
	public partial class EmployeesMetadata : tgMetadata, IMetadata
	{
		...
		protected EmployeesMetadata()
		{
			...
			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.LastName, 0, typeof(System.String), tgSystemType.String);
			c.PropertyName = EmployeesMetadata.PropertyNames.LastName;
			c.CharacterMaxLength = 20;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.FirstName, 0, typeof(System.String), tgSystemType.String);
			c.PropertyName = EmployeesMetadata.PropertyNames.FirstName;
			c.CharacterMaxLength = 10;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.Title, 0, typeof(System.String), tgSystemType.String);
			c.PropertyName = EmployeesMetadata.PropertyNames.Title;
			c.IsNullable = true;
			c.CharacterMaxLength = 30;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.TitleOfCourtesy, 0, typeof(System.String), tgSystemType.String);
			c.PropertyName = EmployeesMetadata.PropertyNames.TitleOfCourtesy;
			c.IsNullable = true;
			c.CharacterMaxLength = 25;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.BirthDate, 0, typeof(System.DateTime), tgSystemType.DateTime);
			c.PropertyName = EmployeesMetadata.PropertyNames.BirthDate;
			c.IsNullable = true;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.HireDate, 0, typeof(System.DateTime), tgSystemType.DateTime);
			c.PropertyName = EmployeesMetadata.PropertyNames.HireDate;
			c.IsNullable = true;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.Address, 0, typeof(System.String), tgSystemType.String);
			c.PropertyName = EmployeesMetadata.PropertyNames.Address;
			c.IsNullable = true;
			c.CharacterMaxLength = 60;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.City, 0, typeof(System.String), tgSystemType.String);
			c.PropertyName = EmployeesMetadata.PropertyNames.City;
			c.IsNullable = true;
			c.CharacterMaxLength = 15;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.Region, 0, typeof(System.String), tgSystemType.String);
			c.PropertyName = EmployeesMetadata.PropertyNames.Region;
			c.IsNullable = true;
			c.CharacterMaxLength = 15;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.PostalCode, 0, typeof(System.String), tgSystemType.String);
			c.PropertyName = EmployeesMetadata.PropertyNames.PostalCode;
			c.IsNullable = true;
			c.CharacterMaxLength = 10;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.Country, 0, typeof(System.String), tgSystemType.String);
			c.PropertyName = EmployeesMetadata.PropertyNames.Country;
			c.IsNullable = true;
			c.CharacterMaxLength = 15;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.HomePhone, 0, typeof(System.String), tgSystemType.String);
			c.PropertyName = EmployeesMetadata.PropertyNames.HomePhone;
			c.IsNullable = true;
			c.CharacterMaxLength = 24;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.Extension, 0, typeof(System.String), tgSystemType.String);
			c.PropertyName = EmployeesMetadata.PropertyNames.Extension;
			c.IsNullable = true;
			c.CharacterMaxLength = 4;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.Photo, 0, typeof(System.Byte[]), tgSystemType.Byte);
			c.PropertyName = EmployeesMetadata.PropertyNames.Photo;
			c.IsNullable = true;
			c.CharacterMaxLength = 2147483647;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.Notes, 0, typeof(System.String), tgSystemType.String);
			c.PropertyName = EmployeesMetadata.PropertyNames.Notes;
			c.IsNullable = true;
			c.CharacterMaxLength = 1073741823;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.ReportsTo, 0, typeof(System.Int32), tgSystemType.Int32);
			c.PropertyName = EmployeesMetadata.PropertyNames.ReportsTo;
			c.IsNullable = true;
			c.NumericPrecision = 10;
			m_columns.Add(c);

			c = new tgColumnMetadata(EmployeesMetadata.ColumnNames.PhotoPath, 0, typeof(System.String), tgSystemType.String);
